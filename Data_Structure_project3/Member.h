...
class Member{
	...
	public:
		...
		Member() = default;
		Member(string);
		Member(bool a,Status b,string c,string d,bool e,string f,string g,bool i):
		alive(a),Id(b),lastname(c),firstname(d),gender(e),birth_date(f),weddingdate(g),state(i){
